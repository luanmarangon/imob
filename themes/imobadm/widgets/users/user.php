            ...
            <form class="app_form" action="<?= url("/admin/users/user"); ?>" method="post">
                ...
                <div class="label_g2">
                    ...
                    <label class="label">
                        ...
                        <input type="text" name="office" placeholder="Cargo" required />
                    </label>
                </div>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/users/user/{$user->id}"); ?>" method="post">
                ...
                <div class="label_g2">
                    ...
                    <label class="label">
                        <span class="legend">*Cargo:</span>
                        <input type="text" name="office" value="<?= $user->office; ?>" placeholder="Cargo" required />
                    </label>
                </div>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">Nascimento:</span>
                        <input type="text" class="mask-date" value="<?= date_fmt($user->datebirth, "d/m/Y"); ?>" name="datebirth" placeholder="dd/mm/yyyy" />
                    </label>
                    ...
                    <label class="label">
                        ...
                        <select name="level" required>
                            ...
                            <?php if ($user->level === '100') : ?>
                                <option <?= $select(100); ?> value="100">Master</option>

                            <?php else : ?>
                                <option <?= $select(5); ?> value="5">Usuário</option>
                                <option <?= $select(10); ?> value="10">Admin</option>
                            <?php endif; ?>
                        </select>
                    </label>
                ...
                <div class="app_form_footer">
                    <?php if ($user->level != "Inativo") : ?>
                        ...
                        <a href="#" class="btn btn-red icon-warning" data-post="<?= url("/admin/users/user/{$user->id}"); ?>" data-action="delete" data-confirm="ATENÇÃO: Tem certeza que deseja excluir o usuário e todos os dados relacionados a ele? Essa ação não pode ser feita!" data-user_id="<?= $user->id; ?>">Inativar Usuário</a>
                    <?php else : ?>
                        <a href="#" class="btn btn-green icon-warning" data-post="<?= url("/admin/users/user/{$user->id}"); ?>" data-action="ativar" data-confirm="ATENÇÃO: Tem certeza que deseja ativar o usuário!" data-user_id="<?= $user->id; ?>">Ativar Usuário</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
