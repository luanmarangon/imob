        ...
        <section class="app_control_plans">
            ...
            <article class="radius">
                    ...
                    <?php
                        ...
                        foreach ($peopleContacts as $contact) {
                            if ($contact->people_id === $person->id) {
                                ...
                                if ($count <= 2) {
                        ?>
                    <p><b><?= $contact->contact()->type; ?>:</b> <?= $contact->contact()->contact; ?></p>
                    <?php
                                }
                            }
                        }
                ...
                <div class="actions">
                    ...
                    <a class="icon-pencil btn btn-blue" href="<?= url("/admin/people/people-create/{$person->id}"); ?>"
                        title="">Editar</a>
                    ...
                    <a href="#" class="btn btn-red icon-warning"
                        data-post="<?= url("/admin/people/people-create/{$person->id}"); ?>" data-action="delete"
                        ...
                        data-user_id="<?= $person->id; ?>"><span class="icon-ban"></span></a>
                    <?php else : ?>
                    <a href="#" class="btn btn-green icon-warning"
                        data-post="<?= url("/admin/people/people-create/{$person->id}"); ?>" data-action="ativar"
