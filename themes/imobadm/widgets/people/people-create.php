    ...
    <div class="dash_content_app_box">
        <form class="app_form" action="<?= url("/admin/people/people-create/{$people->id}"); ?>" method="post">
            ...
            <div class="label_g2">
                ...
                <label class="label">
                    <span class="legend">Nascimento:</span>
                    <input type="text" class="mask-date" name="datebirth"
                        value="<?= date_fmt($people->birth, "d/m/Y"); ?>" />
                </label>
            </div>
            <div class="label_g2">
                <label class="label">
            ...
            <div class="app_form_footer">
                ...
                <a href="#" class="btn btn-red icon-warning"
                    data-post="<?= url("/admin/people/people-create/{$people->id}"); ?>" data-action="delete"
                    ...
                    data-user_id="<?= $people->id; ?>">Inativar Cliente</a>
                <?php else : ?>
                <a href="#" class="btn btn-green icon-warning"
                    data-post="<?= url("/admin/people/people-create/{$people->id}"); ?>" data-action="ativar"
                    data-confirm="ATENÇÃO: Tem certeza que deseja ativar o cliente!"
                    data-user_id="<?= $people->id; ?>">Ativar Cliente</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
