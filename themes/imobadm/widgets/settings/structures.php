...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        ...
        <form action="<?= url("/admin/settings/structures"); ?>" method="post" class="app_search_form">
    ...
    <section class="app_control_subs radius">
        ...
        <br>
        <div class="newForm">
            <form class="app_form" action="<?= url("/admin/settings/structures"); ?>" method="post">
                <!--ACTION SPOOFING-->
                <input type="hidden" name="action" value="create" />

                <label class="label">
                    <span class="legend">*Estrutura do Imóvel:</span>
                    <input type="text" name="structure" placeholder="O nome da estrutura" required />
                </label>
                <div class="al-right">
        ...
        <section class="app_users_home">
            <?php foreach ($structures as $structure) : ?>
                <article class="user radius">
                    ...
                    <div class="actions">
                        <a class="icon-cog btn btn-blue" href="<?= url("/admin/settings/structuresUpdate/{$structure->id}"); ?>" title="">Gerenciar</a>
                    </div>
                </article>
            <?php endforeach; ?>
        </section>
