...
<body>
    ...
    <div class="dash">
        <aside class="dash_sidebar">
            <article class="dash_sidebar_user">
                ...
                ?>
                <div><img class="dash_sidebar_user_thumb" src="<?= $userPhoto; ?>" alt="" title="" />
    ...
    <!-- <script src="<?= url("/shared/scripts/jquery.js"); ?>"></script>
    <script src="<?= url("/shared/scripts/jquery.mask.min.js"); ?>"></script>
