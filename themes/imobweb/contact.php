    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-12 col-md-4 ">
                ...
                <p class="pt-2"><a href="mailto:<?= CONF_COMPANY_ATTENDANCE_MAIL; ?>" class="text-front"><?= CONF_COMPANY_ATTENDANCE_MAIL; ?></a></p>
            </div>
            <div class="col-12 col-md-4">
                ...
                <p class="text-front pt-2">
                    <span class="icon-phone"><a class="text-front" href="tel:<?= CONF_COMPANY_ATTENDANCE_PHONE; ?>"><?= CONF_COMPANY_ATTENDANCE_PHONE; ?></a>

                        | <span class="icon-whatsapp"><a class="text-front" href="tel:<?= CONF_COMPANY_ATTENDANCE_WHATS; ?>"><?= CONF_COMPANY_ATTENDANCE_WHATS; ?></a></span>
                </p>
