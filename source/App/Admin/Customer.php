...
class Customer extends Admin
{
    ...
    public function inactive(?array $data): void
    {
        // echo "Inativo";
        $data = filter_var_array($data, FILTER_SANITIZE_STRIPPED);
        $lead = (new leads())->findById($data['leads_id']);
        ...
        //Inativo
        // $lead = (new leads())->findById($lead);
        $lead->status = "Inativo";
        $lead->save();

        $this->message->success("Lead Inativo...")->flash();
        // echo json_encode(["redirect" => url("/admin/leads/home")]);
        redirect("/admin/leads/leads");
